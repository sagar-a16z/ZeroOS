...
macro_rules! jolt_print {
    ($($arg:tt)*) => {{
        use core::fmt::Write;
        let _ = write!($crate::ecall::StdoutWriter, $($arg)*);
    }};
}
...
macro_rules! jolt_println {
    ...
    ($($arg:tt)*) => {{
        use core::fmt::Write;
        let _ = writeln!($crate::ecall::StdoutWriter, $($arg)*);
    }};
}

/// Print to stdout (platform-generic name)
#[macro_export]
macro_rules! println {
    () => {{
        $crate::jolt_print!("\n");
...
/// Print to stderr (platform-generic name)
#[macro_export]
macro_rules! eprintln {
    () => {{
        use core::fmt::Write;
        let _ = writeln!($crate::ecall::StderrWriter);
    }};
    ($($arg:tt)*) => {{
        use core::fmt::Write;
        let _ = writeln!($crate::ecall::StderrWriter, $($arg)*);
    }};
}
